...
/* unicycle_ode_impl_dae_fun_jac_x_xdot_u_z:(i0[5],i1[5],i2[2],i3[],i4[])->(o0[5],o1[5x5,5nz],o2[5x5,5nz],o3[5x2,2nz],o4[5x0]) */
...
CASADI_SYMBOL_EXPORT casadi_int unicycle_ode_impl_dae_fun_jac_x_xdot_u_z_n_in(void) { return 5;}
